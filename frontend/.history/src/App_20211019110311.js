...
function App() {
  ...
  const shortenURL = async (url) => {
    ...
    // console.log(typeof )
    const res = await fetch(`http://localhost:8080/api/url/shorten`, { method: "POST",headers:{'Content-type':'application/json','credentials':'same-origin'},body: JSON.stringify(url) });
    console.log(res)
