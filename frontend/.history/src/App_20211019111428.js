...
function App() {
  ...
  const shortenURL = async (url) => {
    ...
    const res = await fetch(`http://localhost:8080/api/url/shorten`, {
      ...
      body: JSON.stringify({
        longUrl:
          "https://shopee.sg/%F0%9F%87%B8%F0%9F%87%AC-LOCAL-SELLER-Laptop-Stand-Foldable-Adjustable-Height-Laptop-Stand-Fits-all-Laptop-including-MacBook-i.360913914.10433386171",
      }),
    });
