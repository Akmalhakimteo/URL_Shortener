...
function App() {
  ...
  const shortenURL = async (url) => {
    ...
    const res = await fetch(`http://localhost:8080/api/url/shorten`, { method: "POST",headers:{'Accept': 'application/json','Content-type':'application/json'},body: JSON.stringify(url) });
